...
- depth: a locally runnable monocular depth model;
- camera: deterministic/simple camera assumptions first, learned estimator second;
- scene representation: point cloud or lightweight mesh before sophisticated neural scene representations;
- novel view: deterministic reprojection/rendering first, generative view synthesis second;
- fusion: deterministic backprojection/point fusion;
...
~~~text
D2a depth/spatial prior
D2b point-cloud/fusion
D2c geometry/mesh
D2d deterministic novel-view rendering
D2e optional learned novel-view generator
~~~
...
Only after D1/D2 succeed should a learned novel-view generator be inserted. That keeps failures attributable and prevents model setup from hiding a coordination bug.
