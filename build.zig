...
pub fn build(b: *std.Build) void {
    ...
    const evoscene_d3_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("demos/evoscene-emergent/src/d3_test_root.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const evoscene_d3_test_step = b.step(
        "test-demo-evoscene-d3",
