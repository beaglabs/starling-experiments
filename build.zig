...
pub fn build(b: *std.Build) void {
    ...
    const evoscene_d2a_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("demos/evoscene-emergent/src/d2a_test_root.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    const run_evoscene_d2a_tests = b.addRunArtifact(evoscene_d2a_tests);

    const evoscene_d2b_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("demos/evoscene-emergent/src/d2b_test_root.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    const run_evoscene_d2b_tests = b.addRunArtifact(evoscene_d2b_tests);

    const evoscene_d2c_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("demos/evoscene-emergent/src/d2c_test_root.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    const run_evoscene_d2c_tests = b.addRunArtifact(evoscene_d2c_tests);

    const evoscene_d2d_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("demos/evoscene-emergent/src/d2d_test_root.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const evoscene_d2f_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("demos/evoscene-emergent/src/d2f_test_root.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    const run_evoscene_d2f_tests = b.addRunArtifact(evoscene_d2f_tests);
    ...
    test_step.dependOn(&run_evoscene_d2a_tests.step);
    ...
    test_step.dependOn(&run_evoscene_d2f_tests.step);
    ...
    const evoscene_d2a_test_step = b.step(
        "test-demo-evoscene-d2a",
        "Run EvoScene-emergent D2a spatial-prior contract tests",
    );
    evoscene_d2a_test_step.dependOn(&run_evoscene_d2a_tests.step);

    const evoscene_d2b_test_step = b.step(
        "test-demo-evoscene-d2b",
        "Run EvoScene-emergent D2b backprojection contract tests",
    );
    evoscene_d2b_test_step.dependOn(&run_evoscene_d2b_tests.step);

    const evoscene_d2c_test_step = b.step(
        "test-demo-evoscene-d2c",
        "Run EvoScene-emergent D2c fusion/refinement contract tests",
    );
    evoscene_d2c_test_step.dependOn(&run_evoscene_d2c_tests.step);

    const evoscene_d2d_test_step = b.step(
        "test-demo-evoscene-d2d",
    ...
    const evoscene_d2f_test_step = b.step(
        "test-demo-evoscene-d2f",
        "Run EvoScene-emergent D2f learned novel-view contract tests",
    );
    evoscene_d2f_test_step.dependOn(&run_evoscene_d2f_tests.step);
    ...
    addRunStep(
        ...
        "Run EvoScene-emergent D2a real spatial-prior contract validation",
        "demos/evoscene-emergent/src/d2a_cli.zig",
    );
    addRunStep(
        b,
        target,
        ...
        "Run EvoScene-emergent D2b backprojection contract validation",
        "demos/evoscene-emergent/src/d2b_cli.zig",
    );
    addRunStep(
        b,
        target,
        ...
        "Run EvoScene-emergent D2c fusion/refinement contract validation",
        "demos/evoscene-emergent/src/d2c_cli.zig",
    );
    addRunStep(
        b,
        target,
    ...
    addRunStep(
        ...
        "Run EvoScene-emergent D2f learned novel-view contract validation",
        "demos/evoscene-emergent/src/d2f_cli.zig",
    );
